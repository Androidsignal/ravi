...
(() => {
  ...
  function load() {
    ...
    // Baked publish build: an inlined state global lets a single self-
    // contained HTML restore dropped images + crops with no sidecar fetch.
    try {
      var seed = window.__IMAGE_SLOTS_STATE;
      if (seed && typeof seed === 'object') slots = Object.assign({}, seed, slots);
    } catch (e) {}
